package com.seangogo.blogs.config.shiro.token.manager;

import com.seangogo.blogs.config.shiro.MyRealm;
import com.seangogo.blogs.config.shiro.session.CustomSessionManager;
import com.seangogo.blogs.config.shiro.token.ShiroToken;
import com.seangogo.blogs.domain.Admin;
import com.seangogo.blogs.utils.SpringContextUtil;
...
public class TokenManager {
	//用户登录管理
	public static final MyRealm realm = SpringContextUtil.getBean("sampleRealm",MyRealm.class);
	//用户session管理
	...
	public static String getUserId(){
		return getToken()==null?null:getToken().id();
	}
	/**
	...
	public static Admin login(Admin admin,Boolean rememberMe){
		ShiroToken token = new ShiroToken(admin.email(), admin.password());
